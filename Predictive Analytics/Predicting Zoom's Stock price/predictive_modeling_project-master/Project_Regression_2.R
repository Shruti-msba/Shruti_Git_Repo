...
MSE_dths_us = mean((pred_usc - zoom_test$Zoom.Open.Price..on.next.day.)^2)
...
summary(lm(Zoom.Open.Price..on.next.day.~poly(Daily.Cases.USA,3),data = zoom_train)) #^2 P>0.05
summary(lm(Zoom.Open.Price..on.next.day.~poly(Daily.Deaths.World,3),data = zoom_train)) 
...
summary(lm(Zoom.Open.Price..on.next.day.~poly(Treasury.Yield.10.Yrs,3),data = zoom_train)) # ^2 ^3 p > 0.05
summary(lm(Zoom.Open.Price..on.next.day.~poly(NASDAQ.Index,3),data = zoom_train))
summary(lm(Zoom.Open.Price..on.next.day.~poly(Treasury.Yield.13.week,3),data = zoom_train))
